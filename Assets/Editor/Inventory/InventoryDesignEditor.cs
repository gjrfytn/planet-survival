    ...
    public override void OnInspectorGUI()
    {
        ...
        {               
            ...
            if (showTitleFont)
            {
                ...
                invDesign.inventoryTitleText.font = (Font)EditorGUILayout.ObjectField("Font", invDesign.inventoryTitleText.font, typeof(Font), true);        
                ...
                if (fontStyleOfInventory == 0) { invDesign.inventoryTitleText.fontStyle = FontStyle.Normal; fontStyleOfInventory = 0; }        
                ...
                invDesign.inventoryTitleText.fontSize = EditorGUILayout.IntField("Font Size", invDesign.inventoryTitleText.fontSize);             
                invDesign.inventoryTitleText.lineSpacing = EditorGUILayout.FloatField("Line Spacing", invDesign.inventoryTitleText.lineSpacing);        
                invDesign.inventoryTitleText.supportRichText = EditorGUILayout.Toggle("Rich Text", invDesign.inventoryTitleText.supportRichText);         
                invDesign.inventoryTitleText.color = EditorGUILayout.ColorField("Color", invDesign.inventoryTitleText.color);        
                invDesign.inventoryTitleText.material = (Material)EditorGUILayout.ObjectField("Material", invDesign.inventoryTitleText.material, typeof(Material), true);       
                EditorGUI.indentLevel--;
                GUILayout.Space(20);
                if (EditorGUI.EndChangeCheck())
                {
