...
public class TooltipEditor : Editor
{
    ...
    void toolTipSettings()
    {
        ...
        tooltipWidth.intValue = EditorGUILayout.IntSlider("Tooltip Width:", tooltipWidth.intValue, 0, 500);            
        ...
        GUILayout.BeginVertical("Box");
        showTooltipIcon.boolValue = EditorGUILayout.Toggle("Item Icon", showTooltipIcon.boolValue);      
        ...
        EditorGUILayout.Space();
        GUILayout.BeginVertical("Box");
        showTooltipName.boolValue = EditorGUILayout.Toggle("Item Name", showTooltipName.boolValue);     
        if (showTooltipName.boolValue)
        {
            ...
            if (foldOutName)
            {
                ...
                tooltip.tooltipNameText.font = (Font)EditorGUILayout.ObjectField("Font", tooltip.tooltipNameText.font, typeof(Font), true);      
                string[] fontTypes = new string[4]; fontTypes[0] = "Normal"; fontTypes[1] = "Bold"; fontTypes[2] = "Italic"; fontTypes[3] = "BoldAndItalic";    
                fontStyleOfTooltipName = EditorGUILayout.Popup("Font Style", fontStyleOfTooltipName, fontTypes, EditorStyles.popup);        
                if (fontStyleOfTooltipName == 0) { tooltip.tooltipNameText.fontStyle = FontStyle.Normal; fontStyleOfTooltipName = 0; }         
                ...
                tooltip.tooltipNameText.fontSize = EditorGUILayout.IntField("Font Size", tooltip.tooltipNameText.fontSize);                       
                tooltip.tooltipNameText.lineSpacing = EditorGUILayout.FloatField("Line Spacing", tooltip.tooltipNameText.lineSpacing);             
                tooltip.tooltipNameText.supportRichText = EditorGUILayout.Toggle("Rich Text", tooltip.tooltipNameText.supportRichText);     
                tooltip.tooltipNameText.color = EditorGUILayout.ColorField("Color", tooltip.tooltipNameText.color);
                tooltip.tooltipNameText.material = (Material)EditorGUILayout.ObjectField("Material", tooltip.tooltipNameText.material, typeof(Material), true);       
                EditorGUI.indentLevel--;
                if (EditorGUI.EndChangeCheck())
                {
                    tooltip.updateTooltip();
        ...
        EditorGUILayout.Space();
        GUILayout.BeginVertical("Box");
        showTooltipDesc.boolValue = EditorGUILayout.Toggle("Item Description", showTooltipDesc.boolValue);                 
        if (showTooltipDesc.boolValue)
        {
            ...
            if (foldOutDesc)
            {
                ...
                EditorGUI.indentLevel++;
                EditorGUILayout.TextArea("Character", EditorStyles.boldLabel);
                tooltip.tooltipDescText.font = (Font)EditorGUILayout.ObjectField("Font", tooltip.tooltipDescText.font, typeof(Font), true);              
                string[] fontTypes = new string[4]; fontTypes[0] = "Normal"; fontTypes[1] = "Bold"; fontTypes[2] = "Italic"; fontTypes[3] = "BoldAndItalic";     
                fontStyleOfTooltipDesc = EditorGUILayout.Popup("Font Style", fontStyleOfTooltipDesc, fontTypes, EditorStyles.popup);    
                if (fontStyleOfTooltipDesc == 0) { tooltip.tooltipDescText.fontStyle = FontStyle.Normal; fontStyleOfTooltipDesc = 0; }         
                ...
                tooltip.tooltipDescText.fontSize = EditorGUILayout.IntField("Font Size", tooltip.tooltipDescText.fontSize);                                    
                tooltip.tooltipDescText.lineSpacing = EditorGUILayout.FloatField("Line Spacing", tooltip.tooltipDescText.lineSpacing);                          
                tooltip.tooltipDescText.supportRichText = EditorGUILayout.Toggle("Rich Text", tooltip.tooltipDescText.supportRichText);          
                tooltip.tooltipDescText.color = EditorGUILayout.ColorField("Color", tooltip.tooltipDescText.color);
                tooltip.tooltipDescText.material = (Material)EditorGUILayout.ObjectField("Material", tooltip.tooltipDescText.material, typeof(Material), true);     
                EditorGUI.indentLevel--;
